...
public interface ReviewRepository extends JpaRepository<Review,Integer> {
    ...
    //R-2)RS에 선언된 findCourseForReview의 RSL에서 offeringId(개성강의Id) 외래키를 활용해서 User의 이름 Course의 개설강의 정보를 끌어와서 사용하기 위해 선언된 쿼리
    ...
    //선언된 validateDuplicateReview 함수에서 EnrollmentId의 값을 활용하여 데이터 조회를 시켜주기 위해 선언된 쿼리
